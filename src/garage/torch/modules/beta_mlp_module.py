...
class BetaMLPBaseModule(nn.Module):
...
class BetaMLPModule(BetaMLPBaseModule):
...
class BetaMLPIndependentStdModule(BetaMLPBaseModule):
...
class BetaMLPTwoHeadedModule(BetaMLPBaseModule):
